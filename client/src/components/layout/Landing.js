...
Analyze Deals the Right Way
      ...
      <div style={{  marginLeft:"auto", marignRight:"auto",  }} className="container valign-wrapper">
      <div className="row">
    ...
    <div className='row raw center-align' style={{}}>
      <p calssName='raw center-align' style={{fontSize:"34px", marginLeft:" 100px", color:"white", alignItems:"center"}}>New Listings in Orlando, Fl</p>
    </div>
